...
{
    YLClient *client = [YLClient new];
//    NSDictionary *paramDictionary = @{@"location": @"berlin",@"cll" : [NSString stringWithFormat:@"%f,%f",location.coordinate.latitude,location.coordinate.longitude]};
    
    NSDictionary *paramDictionary = @{@"radius_filter":@"200",@"ll" : [NSString stringWithFormat:@"%f,%f",location.coordinate.latitude,location.coordinate.longitude]};
